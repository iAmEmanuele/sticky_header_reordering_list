library sticky_header_reordering_list;

import 'package:flutter/material.dart';
import 'package:sticky_header_reordering_list/utils/measure_size.dart';

/// A widget that displays a reorderable list with sticky headers.
///
/// The `StickyHeaderReorderableList` allows you to group items by sections,
...
/// );
/// ```
class StickyHeaderReorderableList<T> extends StatefulWidget {
  ...
  /// Creates a [StickyHeaderReorderableList] widget.
  const StickyHeaderReorderableList(
      {super.key,
        required this.items,
  ...
  @override
  State<StickyHeaderReorderableList> createState() =>
      _StickyHeaderReorderableListState<T>();
}

class _StickyHeaderReorderableListState<T>
    extends State<StickyHeaderReorderableList<T>> {
